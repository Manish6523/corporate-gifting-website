...
const EnquiryPage = () => {
  ...
  const handleAddAddress = async () => {
    ...
    const response = await AddAddress(address, phone, firstname, lastname, dispatch);
    if (response.success) {
            ...
            <td className="py-2">
              <div className="flex items-center gap-3">
                ...
                <div className="flex flex-col">
                  ...
                  <p className="text-xs text-text/60">Quantity: {e.quantity}</p>
                </div>
              </div>
            </td>
  ...
  <div className="total sticky w-full bottom-0 left-0 bg-background px-5 py-2 border-t border-gray-300">
    ...
    <div className="flex justify-between font-semibold text-lg text-text">
      ...
      <div className="left md:order-1 border-r border-gray-300 overflow-y-auto">
        <h1 className="w-full text-center text-3xl font-semibold mb-9 mt-7 text-text">Details</h1>
        ...
        {!toggleAddress && (
          <form className="flex flex-col gap-6 p-6 w-full max-w-3xl mx-auto">
            ...
            {/* Address Field */}
            <div className="flex flex-col">
              <label htmlFor="newAddress" className="text-sm font-medium text-text mb-1">
                Add New Address
              </label>
              <input
                type="text"
        ...
        {toggleAddress && (
          <div className="flex flex-col gap-6 p-6 mx-auto">
            <div className="w-full flex items-center justify-between mb-4 border-b border-gray-300 pb-4">
              <h1 className="text-2xl sm:text-3xl font-medium text-text">Shipping Information</h1>
              <button
            ...
            <div className="text-xl font-medium text-text">Select your address</div>
